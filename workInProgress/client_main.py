...
if (picPath[-3: ] == "jpg"):
    ...
    userMsg = "type=vid/status=new/vid=play/prev=n"
...
def on_message(client, userdata, msg):
    ...
    nextStep = input("Press c to continue, press q to quit everything, press n to load in new video or picture file: ")
    print(nextStep)
    if nextStep == "n":
        ...
        userMsg = "type=vid/status=old/vid=play/prev=n"
